...
{
    /// <summary>
    /// Class with functions to calcute area of figure and more.
    /// </summary>
    public static class Figure // Добавлять методы подсчета других фигур можно за счет перегрузки метода CalculateSquare
    {
        /// <summary>
